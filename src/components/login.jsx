                ...
                <div className="card shadow">
                    <div className="container px-0 pb-2">
                        ...
                        <div className="col-6 offset-3">
                            <form action="https://tour-explore.herokuapp.com/login" method="post" className="needs-validation">
                                <div className="mb-3">
                                    <label className="form-label" htmlFor="username">Username</label>
                                    <input className="form-control" type="text" name="username" id="username" autoFocus required />
                                </div>
                                <div className="mb-3">

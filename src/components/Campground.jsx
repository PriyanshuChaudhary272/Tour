...
function Campgrounds() {
    ...
    return (
        <div className="container my-5 pt-3 pt-sm-5">
            <h1 className='Home-Heading'>Find Your Place!</h1>
            <div ref={mapContainer} className="map-container mb-2 Global-map" />
            {/* <a href="/campgrounds/add">New camp</a> */}
            <ul className="ps-0 d-flex flex-wrap">
                {camps.map(e =>
                    // <div className='p-0 col-6 '>
                        <div className="card mb-3 p-0 col-6" key={e._id}>
                            <div className="row">
